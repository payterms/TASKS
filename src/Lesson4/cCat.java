...
public class cCat extends cAnimal{
    ...
    public cCat(String _name, float _maxRunDistance, float _maxSwimDistance, float _maxJumpDistance) {
        this.name = _name;
        this.maxRunDistance = _maxRunDistance;
        this.maxSwimDistance = _maxSwimDistance;
        this.maxJumpDistance = _maxJumpDistance;
    }
    public cCat(float _maxRunDistance, float _maxSwimDistance, float _maxJumpDistance) {
        this.name = "CAT";
        this.maxRunDistance = _maxRunDistance;
        this.maxSwimDistance = _maxSwimDistance;
        this.maxJumpDistance = _maxJumpDistance;
